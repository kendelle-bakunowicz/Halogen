...
public:
	...
	void StartSearch(unsigned int maxTime, unsigned int allocatedTime);	//pass the allowed search time maximum in milliseconds

private:
	Timer timer;
	unsigned int AllocatedSearchTimeMS;
